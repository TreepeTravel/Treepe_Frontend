  ...
  return (
    <>
        ...
        <section className="pt-12 sm:pb-16 lg:pt-3">
          <div className="px-4 mx-auto max-w-7xl sm:px-6">
            <div className=" flex justify-center">
              <div className="grid grid-cols-1 gap-8  w-full justify-between lg:grid-cols-2">
                {/* Text Section */}
                <div className="text-center lg:mt-52 mb-16 lg:text-left">
      ...
      <div className="bg-white">
        <section className="pt-12 pb-12 sm:pb-16 lg:pt-10">
          <div className="mx-auto max-w-7xl sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-x-24">
              {/* Image Section */}
